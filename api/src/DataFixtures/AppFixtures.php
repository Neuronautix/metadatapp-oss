...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        // Golden demo slice: one linked FAIR experiment spanning ELN, subject metadata, and DVC activity data.
        ...
        $demoProject = (new Project())
            ...
            ->setGoal('Integrate eLabFTW protocol metadata, subject/cage records, and DVC home-cage activity into one reusable experiment graph.')
