    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $connectedApps = [
            ...
            [
                ...
                'name' => 'SoftMouse (Demo)',
                'externalUrl' => 'https://example.invalid/softmouse',
                'authenticationParameters' => ['username' => 'placeholder-user', 'password' => 'placeholder-password'],
            ],
            [
                'code' => AppCode::Fair3r,
                'name' => 'Fair3R (Demo)',
        ...
        foreach ($systems as $systemIndex => $system) {
            ...
            foreach (range(0, 9) as $cageIndex) {
                ...
                SubjectFactory::createOne([
                    ...
                    'softmouseExternalId' => \sprintf('SM-%s-%04d', $system['prefix'], $cageIndex + 1),
                ]);
    ...
    private function createSubjects(
        ...
        foreach (range(1, $count) as $i) {
            $subjects[] = SubjectFactory::createOne([
                ...
                'softmouseExternalId' => \sprintf('SM-%s-%04d', $prefix, $i),
