...
#[ORM\Entity]
#[ApiResource]
class SchemaFieldMappingProposal
{
    #[ORM\Id]
    ...
    #[Groups(['proposal.read'])]
    private string $decisionStatus = 'undecided'; // undecided, approved, rejected

    #[ORM\Column(type: 'string', length: 50)]
    #[Groups(['proposal.read'])]
    private string $source = 'generated'; // generated, reviewer_override
