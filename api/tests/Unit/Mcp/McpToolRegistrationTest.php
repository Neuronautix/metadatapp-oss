...
use App\ConnectedApps\Reference\ImportedReferenceResult;
use App\ConnectedApps\Reference\ImportReferenceCommand;
use App\ConnectedApps\Reference\ReferenceResult;
use App\ConnectedApps\Reference\Semantic\SimilarReference;
use App\ConnectedApps\Reference\StandardizedReference;
...
final class McpToolRegistrationTest extends TestCase
{
    ...
    public function itDeclaresAllExpectedMcpTools(): void
    {
        $tools = $this->extractToolNames([
            ...
            StandardizedReference::class,
            SimilarReference::class,
            ImportedReferenceResult::class,
            ImportReferenceCommand::class,
