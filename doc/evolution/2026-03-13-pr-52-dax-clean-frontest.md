...
- Expanded backend and integration groundwork at the same time, including new Precliniset and Tecniplast service wiring in `api/config/services.yaml`, new IMPC import scaffolding, and local host / CORS updates in `api/.env`.
