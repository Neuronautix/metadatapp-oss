...
- Added app-specific validation and masking rules in `ConnectedApp`, including required `username` / `password` handling for private integration and token-like key support for Fair3R, ElabFTW, Protocol.io, and Tecniplast.
