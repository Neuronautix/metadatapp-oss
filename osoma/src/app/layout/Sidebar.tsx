...
export function Sidebar() {
  ...
  const referenceHubEnabled = useFeatureFlag('feature.referenceHub')
  const guidelinesEnabled = useFeatureFlag('feature.guidelinesReporting')
...
const subjectsItems: NavItem[] = [
  ...
  const intelligenceItems: NavItem[] = [
    ...
    { to: '/hcm/metadata-form', label: 'HCM Metadata Form', icon: ClipboardList },
    ...(metadatappEnabled ? [{ to: '/metadata', label: 'Metadata Catalog', icon: BookOpenCheck }] : []),
    ...(metadatappEnabled && guidelinesEnabled ? [{ to: '/guidelines', label: 'Guidelines', icon: ShieldCheck }] : []),
  ...
  const connectedAppsItems: NavItem[] = [
    ...(metadatappEnabled && connectedAppsEnabled
      ? [
          { to: '/connected-apps/showcase', label: 'Live Showcase', icon: GitBranch },
          { to: '/connected-apps', label: 'App Directory', icon: Network },
        ]
      : []),
    ...(referenceHubEnabled ? [{ to: '/reference-hub', label: 'Reference Hub', icon: Search }] : []),
  ]
