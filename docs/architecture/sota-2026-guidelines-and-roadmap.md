...
| 0.2 | Move demo/fixture code out of `src/` | `api/src/DataFixtures/AppFixtures.php` (1,295 LOC), `api/src/Demo/Sensors/SensorDemoService.php` (1,092 LOC), private integration `Mock/HttpClientMock.php` (859 LOC) |
...
**Done when:** `castor qa:all` passes with zero exclusions and a fresh clone
in dev shows the live API by default.
